...
(function(e, t, i) {
    ...
    function(e) {
        t.matchMedia = t.matchMedia || function(e) {
            ...
            function(e) {
                return o.innerHTML = '­<style media="' + e + '"> #mq-test-1 { width: 42px; }</style>', i.insertBefore(a, n), t = 42 === o.offsetWidth, i.removeChild(a), {
                    matches: t,
                    media: e
                }
            }
    ...
    function(e, n) {
        ...
        P = function() {
            ...
            if (o.pageContainer = o.pageContainer || e.mobile.pageContainer, s = o.pageContainer.children("[data-" + e.mobile.ns + "url='" + u + "']"), 0 === s.length && u && !p.isPath(u) && (s = o.pageContainer.children("#" + u).attr("data-" + e.mobile.ns + "url", u).jqmData("url", u)), 0 === s.length) if (e.mobile.firstPage && p.isFirstPageUrl(h)) e.mobile.firstPage.parent().length && (s = e(e.mobile.firstPage));
    ...
    function(e) {
        e.fn.grid = function(t) {
            return this.each(function() {
                ...
                if (!r) if (5 >= o.length) for (var l in s) s[l] === o.length && (r = l);
